...
namespace LibForLab2.Tests
{
    ...
    public class MatrixTests
    {
        ...
        public void TestIsMyException()
        {
            ...
            try
            {
                if (int.TryParse("1d", out int x))
                {
                    Matrix vec = new Matrix(1, x);
                }
                else throw new  MatrixExeption("Не верный формат строки");
            }
            ...
            Assert.IsInstanceOfType(exception, typeof(MatrixExeption));
